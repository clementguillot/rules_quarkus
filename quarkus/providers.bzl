...
QuarkusContinuousTestInfo = provider(
    ...
    fields = {
        ...
        "conditional_classpath": "Depset of conditional dependency candidates used to assemble the TEST model.",
        "deployment_classpath": "Depset of deployment artifacts used to assemble the TEST model.",
        ...
        "root_ids": "Ordered graph root ids used to assemble the TEST model.",
        "runtime_classpath": "Depset of runtime artifacts used to assemble the TEST model.",
